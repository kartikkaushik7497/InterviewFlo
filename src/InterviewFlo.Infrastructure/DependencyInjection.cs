...
using InterviewFlo.Infrastructure.Persistence;
using InterviewFlo.Infrastructure.Services;
using MongoDB.Bson;
using MongoDB.Driver;

namespace InterviewFlo.Infrastructure;

public static class DependencyInjection
{
    public static IServiceCollection AddInterviewFloInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
